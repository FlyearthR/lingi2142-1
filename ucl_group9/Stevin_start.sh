...
ip address add dev Stevin-eth1 "${PREFIXBASE_as200}:2000::501"
ip address add dev Stevin-eth0 "${PREFIXBASE_as200}:2000::500"
ip address add dev Stevin-eth1 "${PREFIXBASE_as300}:2000::501"
ip address add dev Stevin-eth0 "${PREFIXBASE_as300}:2000::500"
