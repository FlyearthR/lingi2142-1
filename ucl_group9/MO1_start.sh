...
ip address add dev MO1-eth0 "${PREFIXBASE_as200}:2400::1/64"
ip address add dev MO1-eth0 "${PREFIXBASE_as300}:2400::1/64"

ip route add via "${PREFIXBASE_as300}:2400::" dev MO1-eth0 ::/0
ip route add via "${PREFIXBASE_as200}:2400::" dev MO1-eth0 "${PREFIXBASE_as200}::/${PREFIXLEN}"
